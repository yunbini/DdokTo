...
function MultiChoiceSuc(){
    ...
    const {score,LastWords,level,category,user_id,totalQuestions} = location.state;
    console.log(score,LastWords,level,category,user_id,totalQuestions);
    ...
    return(
        <StyledBack>
            ...
            <img src={SitRabit} style={{width:'301px',height:'282px'}}></img>
                ...
                <Choices>
                    <StyledBtn
                        onClick={()=>navigate("/SentenMultiCho",{state:{words:LastWords, level:level, category:category, user_id:user_id}})}
                    >문장만들기</StyledBtn>
